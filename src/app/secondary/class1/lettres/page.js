...
export const metadata = {
  ...
  description: 'Ressources mathématiques pour le Tronc Commun - Section Lettres',
};
...
const resources = [
  ...
  {
    title: 'Exercices',
    href: '/secondary/class1/lettres/exercices',
    description: 'Exercices d\'application et de pratique'
  },
  {
    title: 'Devoirs',
    href: '/secondary/class1/lettres/devoirs',
    description: 'Devoirs et examens corrigés'
  },
  {
    title: 'Résumés',
    href: '/secondary/class1/lettres/resumes',
    description: 'Fiches de révision et résumés'
  }
];

export default function TroncCommunLettersPage() {
  return (
