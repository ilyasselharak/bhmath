  ...
  const sections = [
    {
      ...
      name: "Cours",
      description: "Leçons et contenus théoriques de mathématiques"
    },
    {
        ...
        <div className="bg-gradient-to-r from-orange-200 to-orange-400 text-black rounded-2xl py-16 mb-12">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-lg md:text-xl opacity-90">
              Cours, exercices et devoirs pour la deuxième année du secondaire
            </p>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="bg-orange-100 rounded-xl p-6 mb-8 shadow-sm">
            ...
            <p className="text-gray-600">
              Accédez à toutes les ressources mathématiques pour votre niveau
            </p>
          </div>
