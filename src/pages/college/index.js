        ...
        <div className="bg-gradient-to-r from-orange-200 to-orange-400 text-black rounded-2xl py-16 mb-12">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <h1 className="text-3xl md:text-4xl font-bold mb-6">
              Collège - Ressources Mathématiques
            </h1>
            <p className="text-lg md:text-xl opacity-90">
              Cours, exercices, devoirs et examens pour les élèves du collège
            </p>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="bg-orange-100 rounded-xl p-6 mb-8 shadow-sm">
            ...
            <p className="text-gray-600">
              Choisissez votre année scolaire pour accéder aux ressources adaptées
            </p>
          </div>
