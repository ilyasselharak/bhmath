        ...
        <div className="bg-gradient-to-r from-orange-200 to-orange-400 text-black rounded-2xl py-16 mb-12">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-lg md:text-xl opacity-90">
              Ressources mathématiques pour les élèves de la première année du collège
            </p>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="bg-orange-100 rounded-xl p-6 mb-8 shadow-sm">
            ...
            <p className="text-gray-600">
              Accédez aux différentes ressources pédagogiques adaptées au programme de la première année
            </p>
          </div>
